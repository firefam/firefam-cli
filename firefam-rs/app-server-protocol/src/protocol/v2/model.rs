...
use firefam_protocol::firefamai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use firefam_protocol::firefamai_models::ReasoningEffort;
use firefam_protocol::firefamai_models::default_input_modalities;
use firefam_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use firefam_protocol::protocol::ModelVerification as CoreModelVerification;
