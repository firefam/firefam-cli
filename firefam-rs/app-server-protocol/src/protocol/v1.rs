...
pub use firefam_protocol::protocol::GitSha;
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [firefam_protocol::protocol::PatchApplyBeginEvent]
    /// and [firefam_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [firefam_protocol::protocol::ExecCommandBeginEvent]
    /// and [firefam_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
...
pub struct GetAuthStatusResponse {
    ...
    pub requires_firefamai_auth: Option<bool>,
}
