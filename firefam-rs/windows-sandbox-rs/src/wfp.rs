...
const SESSION_NAME: &str = "Firefam Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Firefam Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Firefam Windows sandbox filters";
const SUBLAYER_NAME: &str = "Firefam Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Firefam Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Firefam-owned identities; do not regenerate them unless we
...
/// Installs the persistent Firefam WFP filters for `account`.
///
...
/// Ensures the persistent Firefam WFP provider exists.
...
/// Ensures the persistent Firefam sublayer exists under the Firefam provider.
