...
use firefam_login::token_data::IdTokenInfo;
...
impl RefreshTokenTestContext {
    ...
    fn load_auth(&self) -> Result<AuthDotJson> {
        load_auth_dot_json(self.firefam_home.path(), AuthCredentialsStoreMode::File)
