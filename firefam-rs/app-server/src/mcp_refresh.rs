...
mod tests {
    ...
    use firefam_config::ThreadConfigContext;
    use firefam_config::ThreadConfigLoadError;
    use firefam_config::ThreadConfigLoadErrorCode;
    ...
    async fn refresh_test_state() -> anyhow::Result<(
        ...
        let auth_manager = AuthManager::from_auth_for_testing(FirefamAuth::from_api_key("dummy"));
