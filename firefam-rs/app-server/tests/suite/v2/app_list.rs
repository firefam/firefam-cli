...
use firefam_app_server_protocol::AppBranding;
use firefam_app_server_protocol::AppInfo;
use firefam_app_server_protocol::AppListUpdatedNotification;
use firefam_app_server_protocol::AppMetadata;
use firefam_app_server_protocol::AppReview;
use firefam_app_server_protocol::AppScreenshot;
...
async fn list_apps_returns_empty_with_api_key_auth() -> Result<()> {
    ...
    save_auth(
        ...
        &AuthDotJson {
            ...
            firefamai_api_key: Some("test-api-key".to_string()),
            tokens: None,
            last_refresh: None,
            agent_identity: None,
        },
...
#[tokio::test]
async fn list_apps_returns_empty_when_workspace_firefam_plugins_disabled() -> Result<()> {
    let connectors = vec![AppInfo {
        id: "beta".to_string(),
        name: "Beta".to_string(),
        description: Some("Beta connector".to_string()),
