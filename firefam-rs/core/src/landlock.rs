...
/// (firefam-linux-sandbox), which defaults to bubblewrap for filesystem
    ...
    P: AsRef<Path>,
{
    ...
    let firefam_linux_sandbox_exe = firefam_linux_sandbox_exe.as_ref();
    ...
    let arg0 = if firefam_linux_sandbox_exe
        .file_name()
        ...
        == Some(FIREFAM_LINUX_SANDBOX_ARG0)
    {
        ...
        firefam_linux_sandbox_exe.to_string_lossy().into_owned()
    } else {
        FIREFAM_LINUX_SANDBOX_ARG0.to_string()
    };
    spawn_child_async(SpawnChildRequest {
        program: firefam_linux_sandbox_exe.to_path_buf(),
        args,
        arg0: Some(&arg0),
        cwd: command_cwd,
