...
use firefam_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use firefam_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use firefam_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use firefam_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use firefam_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use firefam_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> firefam_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<firefam_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: firefam_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            firefam_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            firefam_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            firefam_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
