...
use firefam_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use firefam_protocol::protocol::TokenUsage as CoreTokenUsage;
use firefam_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    /// This is for internal use only (e.g. Firefam Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR FIREFAM CLOUD - DO NOT USE.
...
impl From<firefam_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: firefam_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> firefam_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => firefam_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => firefam_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `firefam_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
