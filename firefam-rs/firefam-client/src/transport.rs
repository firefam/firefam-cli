use crate::default_client::FirefamHttpClient;
use crate::default_client::FirefamRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: FirefamHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<FirefamRequestBuilder, TransportError> {
