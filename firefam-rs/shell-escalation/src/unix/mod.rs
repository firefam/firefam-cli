...
//! `EscalateRequest` over the inherited `FIREFAM_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `FIREFAM_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use firefam_protocol::approvals::EscalationPermissions;
pub use firefam_protocol::approvals::ResolvedPermissionProfile;
