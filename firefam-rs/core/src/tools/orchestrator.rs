...
use firefam_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let attempt_with_network_approval = SandboxAttempt {
            ...
            firefam_linux_sandbox_exe: attempt.firefam_linux_sandbox_exe,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            sandbox_cwd,
            firefam_linux_sandbox_exe: turn_ctx.firefam_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
        ...
        match first_result {
            ...
            Err(ToolError::Firefam(FirefamErr::Sandbox(SandboxErr::Denied {
                output,
    ...
    async fn request_approval<Rq, Out, T>(
        ...
        otel: &firefam_otel::SessionTelemetry,
