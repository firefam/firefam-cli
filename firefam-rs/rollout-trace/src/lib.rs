//! Trace bundle format, writer, and reducer for Firefam rollouts.
//!
//! This crate owns the trace schema. Hot-path Firefam code should depend on the
...
/// Shared recorder context for inference attempts within one Firefam turn.
...
pub use thread::FIREFAM_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Firefam tool boundary.
...
/// Append-only writer used by hot-path Firefam instrumentation.
