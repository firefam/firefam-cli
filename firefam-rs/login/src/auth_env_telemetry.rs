...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            firefamai_api_key_env_present: self.firefamai_api_key_env_present,
            firefam_api_key_env_present: self.firefam_api_key_env_present,
            firefam_api_key_env_enabled: self.firefam_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    firefam_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        firefamai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        firefam_api_key_env_present: env_var_present(CODEX_API_KEY_ENV_VAR),
        firefam_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*firefam_api_key_env_enabled*/ false);
