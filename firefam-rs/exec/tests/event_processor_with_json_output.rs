use firefam_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use firefam_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use firefam_app_server_protocol::CollabAgentTool;
use firefam_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use firefam_app_server_protocol::CommandAction;
use firefam_app_server_protocol::CommandExecutionSource;
use firefam_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use firefam_app_server_protocol::ErrorNotification;
use firefam_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
use firefam_app_server_protocol::ItemCompletedNotification;
use firefam_app_server_protocol::ItemStartedNotification;
use firefam_app_server_protocol::McpToolCallError;
use firefam_app_server_protocol::McpToolCallResult;
use firefam_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use firefam_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use firefam_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use firefam_app_server_protocol::WebSearchAction as ApiWebSearchAction;
...
use firefam_exec::AgentMessageItem;
use firefam_exec::CollabAgentState;
use firefam_exec::CollabAgentStatus;
use firefam_exec::CollabTool;
use firefam_exec::CollabToolCallItem;
use firefam_exec::CollabToolCallStatus;
use firefam_exec::CollectedThreadEvents;
use firefam_exec::CommandExecutionItem;
use firefam_exec::CommandExecutionStatus;
use firefam_exec::ErrorItem;
use firefam_exec::EventProcessorWithJsonOutput;
use firefam_exec::ExecThreadItem;
use firefam_exec::FileChangeItem;
use firefam_exec::FileUpdateChange as ExecFileUpdateChange;
use firefam_exec::FirefamStatus;
use firefam_exec::ItemCompletedEvent;
use firefam_exec::ItemStartedEvent;
use firefam_exec::ItemUpdatedEvent;
use firefam_exec::McpToolCallItem;
use firefam_exec::McpToolCallItemError;
use firefam_exec::McpToolCallItemResult;
use firefam_exec::McpToolCallStatus;
use firefam_exec::PatchApplyStatus;
use firefam_exec::PatchChangeKind;
use firefam_exec::ReasoningItem;
use firefam_exec::ThreadErrorEvent;
use firefam_exec::ThreadEvent;
use firefam_exec::ThreadItemDetails;
use firefam_exec::ThreadStartedEvent;
use firefam_exec::TodoItem;
use firefam_exec::TodoListItem;
use firefam_exec::TurnCompletedEvent;
use firefam_exec::TurnFailedEvent;
use firefam_exec::TurnStartedEvent;
use firefam_exec::Usage;
use firefam_exec::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_configured = SessionConfiguredEvent {
        ...
        approvals_reviewer: firefam_protocol::config_types::ApprovalsReviewer::User,
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: FirefamStatus::InitiateShutdown,
        }
    );
}
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            firefam_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, FirefamStatus::Running);
    ...
    assert_eq!(collected.status, FirefamStatus::InitiateShutdown);
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        firefam_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: firefam_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
