...
use firefam_realtime_webrtc::RealtimeWebrtcEvent;
use firefam_realtime_webrtc::RealtimeWebrtcSessionHandle;
...
pub(crate) enum AppEvent {
    ...
    HooksLoaded {
        cwd: PathBuf,
        result: Result<firefam_app_server_protocol::HooksListResponse, String>,
    },
