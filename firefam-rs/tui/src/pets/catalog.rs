//! Built-in pet catalog ported from the Firefam App avatar catalog.
...
pub(super) const BUILTIN_PETS: &[BuiltinPet] = &[
    BuiltinPet {
        id: "firefam",
        display_name: "Firefam",
        description: "The original Firefam companion",
        spritesheet_file: "firefam-spritesheet-v4.webp",
    },
    BuiltinPet {
        id: "dewey",
        display_name: "Dewey",
