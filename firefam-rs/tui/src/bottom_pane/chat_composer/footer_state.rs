...
pub(super) struct FooterState {
    ...
    pub(super) composer_permissions_line: Option<Line<'static>>,
    pub(super) composer_model_line: Option<Line<'static>>,
    pub(super) composer_directory_line: Option<Line<'static>>,
