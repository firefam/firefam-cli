...
GENERATED_TARGETS = [
    Path("src/firefamai_firefam/generated/notification_registry.py"),
    Path("src/firefamai_firefam/generated/v2_all.py"),
    Path("src/firefamai_firefam/api.py"),
]
...
def test_generated_files_are_up_to_date():
    ...
    assert importlib.metadata.version("firefamai-firefam-cli-bin") == "0.131.0a4"
    env = os.environ.copy()
    env.pop("FIREFAM_EXEC_PATH", None)
