...
use firefam_sandboxing::policy_transforms::effective_network_sandbox_policy;
...
pub struct TurnContext {
    ...
    pub(crate) firefam_self_exe: Option<PathBuf>,
    pub(crate) firefam_linux_sandbox_exe: Option<PathBuf>,
    pub(crate) truncation_policy: TruncationPolicy,
    pub(crate) dynamic_tools: Vec<DynamicToolSpec>,
    pub(crate) turn_metadata_state: Arc<TurnMetadataState>,
    pub(crate) extension_data: Arc<firefam_extension_api::ExtensionData>,
...
impl TurnContext {
    ...
    pub(crate) fn apps_enabled(&self) -> bool {
        let uses_firefam_backend = self
            .auth_manager
            .as_deref()
            .is_some_and(AuthManager::current_auth_uses_firefam_backend);
        self.features.apps_enabled_for_auth(uses_firefam_backend)
    }
    ...
    pub(crate) async fn with_model(
        ...
        Self {
            ...
            firefam_self_exe: self.firefam_self_exe.clone(),
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        let extension_data = Arc::new(firefam_extension_api::ExtensionData::new(sub_id.clone()));
        TurnContext {
            sub_id,
            ...
            firefam_self_exe: per_turn_config.firefam_self_exe.clone(),
            firefam_linux_sandbox_exe: per_turn_config.firefam_linux_sandbox_exe.clone(),
    ...
    pub(crate) async fn new_turn_with_sub_id(
    ...
    ) -> FirefamResult<Arc<TurnContext>> {
        let notify_config_contributors = !self.services.extensions.config_contributors().is_empty();
        let update_result: FirefamResult<_> = {
            ...
            match state.session_configuration.clone().apply(&updates) {
                Ok(next) => {
                    ...
                    let firefam_home = next.firefam_home.clone();
                ...
                Err(err) => Err(FirefamErr::InvalidRequest(err.to_string())),
            }
        };
        ...
        let (
            ...
            Err(err) => {
                ...
                .await;
                return Err(FirefamErr::InvalidRequest(message));
            }
        };
    ...
    ) -> FirefamResult<ResolvedTurnEnvironments> {
