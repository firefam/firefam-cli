...
PACKAGE_VARIANTS: dict[str, PackageVariant] = {
    "firefam": PackageVariant(
        name="firefam",
        cargo_bin="firefam",
        executable_stem="firefam",
    ),
    "firefam-app-server": PackageVariant(
        name="firefam-app-server",
        cargo_bin="firefam-app-server",
        executable_stem="firefam-app-server",
    ),
}
