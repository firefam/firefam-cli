...
mod exec_approval;
mod firefam_tool_config;
mod firefam_tool_runner;
...
pub use crate::firefam_tool_config::FirefamToolCallParam;
pub use crate::firefam_tool_config::FirefamToolCallReplyParam;
...
const OTEL_SERVICE_NAME: &str = "firefam_mcp_server";
...
mod tests {
    ...
    async fn mcp_server_builds_otel_provider_with_logs_traces_and_metrics() -> anyhow::Result<()> {
        ...
        let provider = firefam_core::otel_init::build_provider(
            &config,
            "0.0.0-test",
            Some(OTEL_SERVICE_NAME),
            DEFAULT_ANALYTICS_ENABLED,
