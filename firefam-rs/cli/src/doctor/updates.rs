//! Diagnoses whether Firefam update paths target the running installation.
//!
...
const GITHUB_LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/firefam/firefam-cli/releases/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/firefam.json";
...
pub(super) fn updates_check(config: &Config) -> DoctorCheck {
    ...
    let version_file = config.firefam_home.join(VERSION_FILE_NAME);
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g firefam/firefam-cli",
        InstallMethod::Bun => "bun install -g firefam/firefam-cli",
        InstallMethod::Brew => "npm install -g firefam/firefam-cli",
