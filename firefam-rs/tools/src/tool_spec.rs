...
use firefam_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
use firefam_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
use firefam_protocol::config_types::WebSearchUserLocationType;
use serde::Serialize;
use serde_json::Value;

/// When serialized as JSON, this produces a valid "Tool" in the FirefamAI
/// Responses API.
