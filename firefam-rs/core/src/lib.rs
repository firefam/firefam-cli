//! Root of the `firefam-core` library.
...
mod config_lock;
mod firefam_thread;
pub use firefam_thread::FirefamThread;
pub use firefam_thread::FirefamThreadSettingsOverrides;
pub use firefam_thread::ThreadConfigSnapshot;
...
pub use firefam_mcp::SandboxState;
mod mcp_firefamai_file;
mod mcp_tool_call;
...
pub use firefam_protocol::config_types::ModelProviderAuthInfo;
mod event_mapping;
...
#[deprecated(note = "use FirefamThread")]
pub type FirefamConversation = FirefamThread;
...
pub use client::X_FIREFAM_INSTALLATION_ID_HEADER;
pub use client::X_FIREFAM_TURN_METADATA_HEADER;
