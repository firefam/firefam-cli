...
/// Authentication mode for FirefamAI-backed providers.
#[derive(Serialize, Deserialize, Debug, Clone, Copy, PartialEq, Eq, Display, JsonSchema, TS)]
#[serde(rename_all = "lowercase")]
pub enum AuthMode {
    /// FirefamAI API key provided by the caller and stored by Firefam.
    ApiKey,
    /// ChatGPT OAuth managed by Firefam (tokens persisted and refreshed by Firefam).
    Chatgpt,
    /// [UNSTABLE] FOR FIREFAMAI INTERNAL USE ONLY - DO NOT USE.
    ///
    ...
    ChatgptAuthTokens,
    /// Programmatic Firefam auth backed by a registered Agent Identity.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a Firefam sandbox.
...
/// Superset of [`firefam_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Firefam Cloud.
