...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: firefam_app_server_protocol::Thread,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<FirefamThread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<FirefamThread>) -> bool {
