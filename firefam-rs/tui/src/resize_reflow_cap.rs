...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Firefam is rebuilding normal terminal scrollback, not an
...
use firefam_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
