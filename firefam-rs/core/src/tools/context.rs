...
use firefam_protocol::models::function_call_output_content_items_to_text;
use firefam_tools::LoadableToolSpec;
use firefam_tools::ToolName;
use firefam_utils_output_truncation::TruncationPolicy;
use firefam_utils_output_truncation::formatted_truncate_text;
use firefam_utils_string::take_bytes_at_char_boundary;
use serde::Serialize;
...
pub enum ToolCallSource {
    ...
    CodeMode {
        ...
        /// debugging the JS/runtime bridge, but it is not the Firefam tool call id
