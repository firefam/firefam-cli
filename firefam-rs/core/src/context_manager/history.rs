...
use firefam_utils_cache::BlockingLruCache;
use firefam_utils_cache::sha1_digest;
use firefam_utils_output_truncation::TruncationPolicy;
use firefam_utils_output_truncation::approx_bytes_for_tokens;
use firefam_utils_output_truncation::approx_token_count;
use firefam_utils_output_truncation::approx_tokens_from_byte_count_i64;
...
pub(crate) fn is_firefam_generated_item(item: &ResponseItem) -> bool {
    matches!(
        item,
        ResponseItem::FunctionCallOutput { .. }
            | ResponseItem::ToolSearchOutput { .. }
