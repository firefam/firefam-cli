use super::FirefamErrorInfo;
use super::ThreadItem;
use super::ThreadStatus;
use super::TurnStatus;
use firefam_protocol::protocol::SessionSource as CoreSessionSource;
use firefam_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use firefam_protocol::protocol::ThreadSource as CoreThreadSource;
...
pub struct Thread {
    ...
    /// Origin of the thread (CLI, VSCode, firefam exec, firefam app-server, etc.).
