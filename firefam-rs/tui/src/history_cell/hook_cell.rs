...
use firefam_app_server_protocol::HookOutputEntry;
use firefam_app_server_protocol::HookOutputEntryKind;
use firefam_app_server_protocol::HookRunStatus;
use firefam_app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
