...
use firefam_tools::LoadableToolSpec;
use firefam_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use firefam_tools::TOOL_SEARCH_TOOL_NAME;
use firefam_tools::ToolName;
use firefam_tools::ToolSearchSourceInfo;
use firefam_tools::ToolSpec;
use firefam_tools::coalesce_loadable_tool_specs;
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        ...
        assert_eq!(
            ...
            vec![
                LoadableToolSpec::Namespace(ResponsesApiNamespace {
                    ...
                    tools: vec![
                        ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                            ...
                            parameters: firefam_tools::JsonSchema::object(
                                Default::default(),
                                /*required*/ None,
                                Some(false.into()),
                            ),
                ...
                LoadableToolSpec::Namespace(ResponsesApiNamespace {
                    name: "firefam_app".to_string(),
                    description: "Tools in the firefam_app namespace.".to_string(),
                    tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                        ...
                        parameters: firefam_tools::JsonSchema::object(
                            std::collections::BTreeMap::from([(
                                "mode".to_string(),
                                firefam_tools::JsonSchema::string(/*description*/ None),
                            )]),
