use firefam_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use firefam_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use firefam_protocol::config_types::CollaborationModeMask;
use firefam_protocol::config_types::ModeKind;
use firefam_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
