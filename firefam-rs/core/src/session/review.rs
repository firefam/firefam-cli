...
pub(super) async fn spawn_review_thread(
    ...
    let review_turn_context = TurnContext {
        ...
        firefam_self_exe: parent_turn_context.firefam_self_exe.clone(),
        firefam_linux_sandbox_exe: parent_turn_context.firefam_linux_sandbox_exe.clone(),
        dynamic_tools: parent_turn_context.dynamic_tools.clone(),
        truncation_policy: model_info.truncation_policy.into(),
        turn_metadata_state,
        extension_data: Arc::new(firefam_extension_api::ExtensionData::new(review_turn_id)),
