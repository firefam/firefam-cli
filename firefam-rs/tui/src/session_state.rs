...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: firefam_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<firefam_protocol::firefamai_models::ReasoningEffort>,
