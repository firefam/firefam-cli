...
use firefam_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use firefam_protocol::protocol::SkillInterface as CoreSkillInterface;
use firefam_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use firefam_protocol::protocol::SkillScope as CoreSkillScope;
use firefam_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
