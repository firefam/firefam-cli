...
use firefam_protocol::approvals::NetworkApprovalContext;
...
use firefam_sandboxing::SandboxTransformError;
...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and firefam prompts the user to run outside the sandbox.
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub permissions: &'a firefam_protocol::models::PermissionProfile,
    pub enforce_managed_network: bool,
    pub(crate) manager: &'a SandboxManager,
    pub(crate) sandbox_cwd: &'a AbsolutePathBuf,
    pub firefam_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
    ...
    pub fn env_for(
        ...
        self.manager
            .transform(SandboxTransformRequest {
                ...
                firefam_linux_sandbox_exe: self
            ...
            .map(|request| {
                let windows_sandbox_policy_cwd =
                    firefam_utils_absolute_path::AbsolutePathBuf::try_from(
