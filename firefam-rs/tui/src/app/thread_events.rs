...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<firefam_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use firefam_app_server_protocol::HookEventName as AppServerHookEventName;
    use firefam_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use firefam_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use firefam_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use firefam_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use firefam_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use firefam_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use firefam_app_server_protocol::HookScope as AppServerHookScope;
