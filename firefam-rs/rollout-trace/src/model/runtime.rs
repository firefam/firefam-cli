...
/// Runtime operation requested by the model, a JS code cell, or Firefam itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_firefam_turn_id: Option<FirefamTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Firefam tool boundary.
    ///
    ...
    /// they describe how Firefam executed the request, not what the caller sent.
