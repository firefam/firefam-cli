extern crate firefam_execpolicy_legacy;

use firefam_execpolicy_legacy::ArgType;
use firefam_execpolicy_legacy::Error;
use firefam_execpolicy_legacy::ExecCall;
use firefam_execpolicy_legacy::MatchedArg;
use firefam_execpolicy_legacy::MatchedExec;
use firefam_execpolicy_legacy::MatchedFlag;
use firefam_execpolicy_legacy::MatchedOpt;
use firefam_execpolicy_legacy::Policy;
use firefam_execpolicy_legacy::Result;
use firefam_execpolicy_legacy::ValidExec;
use firefam_execpolicy_legacy::get_default_policy;
