...
use firefam_app_server_protocol::RemoteControlEnableResponse;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<firefam_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_FIREFAM_HOME: &str = "/tmp/firefam-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "firefam_app_server/1.2.3",
                    "firefamHome": TEST_FIREFAM_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
