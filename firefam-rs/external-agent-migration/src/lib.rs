...
use firefam_hooks::HOOK_EVENT_NAMES;
use firefam_hooks::HOOK_EVENT_NAMES_WITH_MATCHERS;
...
mod tests {
    ...
    fn migrated_quoted_hook_command(script_name: &str) -> String {
        let hook_path = Path::new("/repo/.firefam")
...
"#
    ...
    #[test]
    fn command_skill_names_must_fit_firefam_skill_loader_limit() {
        let root = source_path("commands");
    ...
    #[test]
    fn subagent_requires_minimum_firefam_agent_fields() {
...
"#,
    ...
    fn hook_command_paths_rewrite_to_target_hook_dir() {
        ...
        assert_eq!(
            rewrite_hook_command(&plugin_script_command, Some(Path::new("/repo/.firefam")),),
