...
use firefam_protocol::protocol::HookEventName as CoreHookEventName;
use firefam_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use firefam_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use firefam_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use firefam_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use firefam_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use firefam_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use firefam_protocol::protocol::HookScope as CoreHookScope;
use firefam_protocol::protocol::HookSource as CoreHookSource;
use firefam_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
