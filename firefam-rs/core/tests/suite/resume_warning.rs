...
async fn emits_warning_when_resumed_model_differs() {
    ...
    let thread_manager = firefam_core::test_support::thread_manager_with_models_provider(
        FirefamAuth::from_api_key("test"),
        config.model_provider.clone(),
    );
    let auth_manager =
        firefam_core::test_support::auth_manager_from_auth(FirefamAuth::from_api_key("test"));
