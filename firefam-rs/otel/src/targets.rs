pub(crate) const OTEL_TARGET_PREFIX: &str = "firefam_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "firefam_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "firefam_otel.trace_safe";
