...
use firefam_protocol::models::SandboxPermissions;
use firefam_protocol::protocol::GuardianAssessmentOutcome;
use firefam_protocol::protocol::GuardianCommandSource;
use firefam_protocol::protocol::GuardianRiskLevel;
use firefam_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(FirefamAppMentionedEventRequest),
    AppUsed(FirefamAppUsedEventRequest),
    HookRun(FirefamHookRunEventRequest),
    Compaction(Box<FirefamCompactionEventRequest>),
    TurnEvent(Box<FirefamTurnEventRequest>),
    TurnSteer(FirefamTurnSteerEventRequest),
    CommandExecution(FirefamCommandExecutionEventRequest),
    FileChange(FirefamFileChangeEventRequest),
    McpToolCall(FirefamMcpToolCallEventRequest),
    DynamicToolCall(FirefamDynamicToolCallEventRequest),
    CollabAgentToolCall(FirefamCollabAgentToolCallEventRequest),
    WebSearch(FirefamWebSearchEventRequest),
    ImageGeneration(FirefamImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<FirefamAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(FirefamReviewEventRequest),
    PluginUsed(FirefamPluginUsedEventRequest),
    PluginInstalled(FirefamPluginEventRequest),
    PluginUninstalled(FirefamPluginEventRequest),
    PluginEnabled(FirefamPluginEventRequest),
    PluginDisabled(FirefamPluginEventRequest),
}
...
#[derive(Serialize)]
pub(crate) struct FirefamAcceptedLineFingerprintsEventParams {
...
#[derive(Serialize)]
pub(crate) struct FirefamAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamAcceptedLineFingerprintsEventParams,
}
...
pub(crate) struct FirefamAppServerClientMetadata {
...
#[derive(Clone, Serialize)]
pub(crate) struct FirefamRuntimeMetadata {
    pub(crate) firefam_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    pub(crate) thread_id: String,
    pub(crate) app_server_client: FirefamAppServerClientMetadata,
    pub(crate) runtime: FirefamRuntimeMetadata,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main Firefam turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct FirefamToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct FirefamReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct FirefamReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct FirefamCommandExecutionEventParams {
    #[serde(flatten)]
    pub(crate) base: FirefamToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct FirefamCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct FirefamFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: FirefamToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct FirefamFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct FirefamMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: FirefamToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct FirefamMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct FirefamDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: FirefamToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct FirefamDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct FirefamCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: FirefamToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct FirefamCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct FirefamWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: FirefamToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct FirefamWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct FirefamImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: FirefamToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct FirefamImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct FirefamAppMetadata {
...
#[derive(Serialize)]
pub(crate) struct FirefamAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct FirefamAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct FirefamHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct FirefamHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct FirefamCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: FirefamAppServerClientMetadata,
    pub(crate) runtime: FirefamRuntimeMetadata,
...
#[derive(Serialize)]
pub(crate) struct FirefamCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct FirefamTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) turn_error: Option<FirefamErrorInfo>,
...
#[derive(Serialize)]
pub(crate) struct FirefamTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct FirefamTurnSteerEventParams {
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct FirefamTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct FirefamPluginMetadata {
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct FirefamPluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: FirefamPluginMetadata,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
}
...
#[derive(Serialize)]
pub(crate) struct FirefamPluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamPluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct FirefamPluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: FirefamPluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "firefam_plugin_installed",
        PluginState::Uninstalled => "firefam_plugin_uninstalled",
        PluginState::Enabled => "firefam_plugin_enabled",
        PluginState::Disabled => "firefam_plugin_disabled",
    }
}

pub(crate) fn firefam_app_metadata(
...
pub(crate) fn firefam_plugin_metadata(plugin: PluginTelemetryMetadata) -> FirefamPluginMetadata {
...
pub(crate) fn firefam_compaction_event_params(
...
pub(crate) fn firefam_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> FirefamPluginUsedMetadata {
    FirefamPluginUsedMetadata {
        plugin: firefam_plugin_metadata(plugin),
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
    }
...
pub(crate) fn firefam_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> FirefamHookRunMetadata {
    FirefamHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
...
pub(crate) fn current_runtime_metadata() -> FirefamRuntimeMetadata {
    let os_info = os_info::get();
    FirefamRuntimeMetadata {
        firefam_rs_version: env!("CARGO_PKG_VERSION").to_string(),
