...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any Firefam/FirefamAI awareness.
...
- Consumed by higher-level crates like `firefam-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
