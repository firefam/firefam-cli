...
//!
//! For the detailed burst state machine, see `firefam-rs/tui/src/bottom_pane/paste_burst.rs`.
...
#[cfg(test)]
use firefam_core_skills::model::SkillInterface;
    ...
    fn mention_items(&self) -> Vec<MentionItem> {
            ...
            && let Some(snapshot) = self.connectors_snapshot.as_ref()
        {
            for connector in &snapshot.connectors {
                ...
                let display_name = firefam_connectors::metadata::connector_display_label(connector);
...
mod tests {
        ...
        snapshot_composer_state(
            ...
            |composer| {
                ...
                composer.set_status_line(Some(Line::from(
                    "gpt-5.4 high fast · ~/code/firefam-1 · Context 0% used",
                )));
    ...
    fn set_skill_mentions_refreshes_open_mention_popup() {
        ...
        composer.set_skill_mentions(Some(vec![SkillMetadata {
            name: "firefam".to_string(),
            description: "Primary personal Firefam repo skill.".to_string(),
        ...
        assert_eq!(mention.insert_text, "$firefam".to_string());
...
程序员 与 Unicode 同行";
    ...
    fn file_completion_preserves_large_paste_placeholder_elements() {
        ...
        composer.on_file_search_result(
            ...
            vec![FileMatch {
                ...
                match_type: firefam_file_search::MatchType::File,
    ...
    fn pasting_filepath_attaches_image() {
        ...
        let tmp_path: PathBuf = tmp.path().join("firefam_tui_test_paste_image.png");
