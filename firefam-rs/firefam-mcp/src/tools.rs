...
pub(crate) const MCP_TOOLS_CACHE_WRITE_DURATION_METRIC: &str =
    "firefam.mcp.tools.cache_write.duration_ms";
...
pub fn declared_firefamai_file_input_param_names(
    ...
    meta.get(META_FIREFAMAI_FILE_PARAMS)
...
pub(crate) fn tool_with_model_visible_input_schema(tool: &Tool) -> Tool {
    let file_params = declared_firefamai_file_input_param_names(tool.meta.as_deref());
...
const META_FIREFAMAI_FILE_PARAMS: &str = "openai/fileParams";
