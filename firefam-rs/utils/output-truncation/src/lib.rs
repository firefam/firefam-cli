//! Helpers for truncating tool and exec output using [`TruncationPolicy`](firefam_protocol::protocol::TruncationPolicy).

use firefam_protocol::models::FunctionCallOutputContentItem;
pub use firefam_utils_string::approx_bytes_for_tokens;
pub use firefam_utils_string::approx_token_count;
pub use firefam_utils_string::approx_tokens_from_byte_count;
use firefam_utils_string::truncate_middle_chars;
use firefam_utils_string::truncate_middle_with_token_budget;

pub use firefam_protocol::protocol::TruncationPolicy;
