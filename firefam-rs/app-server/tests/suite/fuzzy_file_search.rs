...
use firefam_app_server_protocol::FuzzyFileSearchSessionCompletedNotification;
use firefam_app_server_protocol::FuzzyFileSearchSessionUpdatedNotification;
...
async fn test_fuzzy_file_search_sorts_and_includes_indices() -> Result<()> {
    // Prepare a temporary Firefam home and a separate root with test files.
