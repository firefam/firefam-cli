...
/// directory. If you need Firefam to work from such a checkout simply pass the
...
mod tests {
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:FirefamAI/Firefam.git",
            "ssh://git@github.com/firefamai/firefam.git",
            "ssh://git@github.com:22/FirefamAI/Firefam.git",
            "https://github.com/openai/codex.git",
            "https://github.com:443/firefamai/firefam.git",
            "https://token@github.com/firefamai/firefam/",
            "github.com/FirefamAI/Firefam.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/firefamai/firefam".to_string())
            );
        }
    }
    ...
    fn canonicalize_git_remote_url_rejects_non_repository_values() {
        for remote in ["", "file:///tmp/repo", "github.com/firefamai", "/tmp/repo"] {
