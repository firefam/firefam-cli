...
//!
//! `firefam-rollout-trace` owns the event schema and writer behavior. This module
...
use firefam_rollout_trace::ToolDispatchResult;
use firefam_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        firefam_turn_id: invocation.turn.sub_id.clone(),
