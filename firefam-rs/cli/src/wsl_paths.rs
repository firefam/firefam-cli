...
pub use firefam_utils_path::is_wsl;
...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\firefam.zip").as_deref(),
            Some("/mnt/c/Temp/firefam.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/firefam.tgz").as_deref(),
            Some("/mnt/d/Work/firefam.tgz")
        );
        assert!(win_path_to_wsl("/home/user/firefam").is_none());
    }
