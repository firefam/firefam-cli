# Individual Contributor License Agreement (v1.0, FirefamAI)
...
past and future “Contributions” submitted to the **FirefamAI Firefam CLI project
(the “Project”)**.
...
You grant **FirefamAI, Inc.** and all recipients of software distributed by the
...
You grant **FirefamAI, Inc.** and all recipients of the Project a perpetual,
