...
use firefam_core_plugins::ConfiguredMarketplace;
...
use firefam_core_plugins::marketplace::MarketplaceListError;
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "firefam plugin add",
    after_help = "Examples:\n  firefam plugin add sample@debug\n  firefam plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "firefam plugin list",
    after_help = "Examples:\n  firefam plugin list\n  firefam plugin list --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "firefam plugin remove",
    after_help = "Examples:\n  firefam plugin remove sample@debug\n  firefam plugin remove sample --marketplace debug"
)]
...
fn configured_marketplace_snapshot_issues(
    ...
    let default_install_root = marketplace_install_root(firefam_home);
