use firefam_core_skills::AvailableSkills;
use firefam_core_skills::render_available_skills_body;
use firefam_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
