...
use dirs::home_dir;
use firefam_utils_string::normalize_markdown_hash_location_suffix;
...
///
/// This accepts the path shapes Firefam emits today: `file://` URLs, absolute and relative paths,
