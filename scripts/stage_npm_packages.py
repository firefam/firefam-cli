#!/usr/bin/env python3
"""Stage one or more Firefam npm packages for release."""
...
BUILD_SCRIPT = REPO_ROOT / "firefam-cli" / "scripts" / "build_npm_package.py"
INSTALL_NATIVE_DEPS = REPO_ROOT / "firefam-cli" / "scripts" / "install_native_deps.py"
WORKFLOW_NAME = ".github/workflows/rust-release.yml"
GITHUB_REPO = "firefam/firefam-cli"

_SPEC = importlib.util.spec_from_file_location("firefam_build_npm_package", BUILD_SCRIPT)
...
FIREFAM_PLATFORM_PACKAGES = getattr(_BUILD_MODULE, "FIREFAM_PLATFORM_PACKAGES", {})
...
def tarball_name_for_package(package: str, version: str) -> str:
    if package in FIREFAM_PLATFORM_PACKAGES:
        platform = package.removeprefix("firefam-")
        return f"firefam-npm-{platform}-{version}.tgz"
