{
  description = "Development Nix flake for Firefam CLI";
  ...
  outputs = { self, nixpkgs, rust-overlay, ... }:
    let
      ...
      cargoToml = builtins.fromTOML (builtins.readFile ./firefam-rs/Cargo.toml);
    ...
    in
    {
      packages = forAllSystems (system:
        let
          ...
          firefam-rs = pkgs.callPackage ./firefam-rs {
            inherit version;
