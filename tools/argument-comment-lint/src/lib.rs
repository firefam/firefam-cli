...
rustc_session::declare_lint! {
    ...
    /// }
    ///
    /// create_firefamai_url(/*api_base*/ None);
    /// ```
    ///
    /// Use instead:
    ///
    ...
    /// }
    ///
    /// create_firefamai_url(/*base_url*/ None);
    /// ```
...
fn workspace_crate_filter_accepts_first_party_names_only() {
    assert!(is_workspace_crate_name("firefam_core"));
    assert!(is_workspace_crate_name("firefam_tui"));
