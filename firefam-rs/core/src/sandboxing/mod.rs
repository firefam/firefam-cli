...
command transformation live in the firefam-sandboxing crate; this module keeps
...
pub use firefam_protocol::models::SandboxPermissions;
...
pub(crate) struct ExecServerEnvConfig {
    pub(crate) policy: firefam_exec_server::ExecEnvPolicy,
...
) -> firefam_protocol::error::Result<ExecToolCallOutput> {
