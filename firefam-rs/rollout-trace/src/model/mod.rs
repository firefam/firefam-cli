...
/// Firefam conversation/session UUID.
...
/// Process/session ID returned by Firefam's terminal runtime.
...
/// Canonical reduced graph for one Firefam rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Firefam rollout/session being observed. `trace_id`
    ...
    pub firefam_turns: BTreeMap<FirefamTurnId, FirefamTurn>,
