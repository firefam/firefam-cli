...
use firefam_login::default_client::create_client;
...
impl AnalyticsEventsClient {
    ...
    pub fn track_compaction(&self, event: crate::facts::FirefamCompactionEvent) {
...
async fn send_track_events(
    ...
    let url = format!("{base_url}/firefam/analytics-events/events");
...
async fn send_track_events_request(auth: &FirefamAuth, url: &str, events: Vec<TrackEventRequest>) {
    if events.is_empty() {
        return;
    }
