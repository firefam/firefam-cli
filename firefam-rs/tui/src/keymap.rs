...
use firefam_config::types::KeybindingsSpec;
...
Set unique keys in `~/.agents/firefam-config.toml` and retry. \
...
Set a different key in `~/.agents/firefam-config.toml` and retry. \
See the Firefam keymap documentation for supported actions and examples."
                ));
            }
        }
...
mod tests {
    use super::*;
    use firefam_config::types::KeybindingSpec;
