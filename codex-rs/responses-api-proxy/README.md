...
firefam exec -c "model_providers.openai-proxy={ name = 'OpenAI Proxy', base_url = '${PROXY_BASE_URL}/v1', wire_api='responses' }" \
...
- We leverage [`codex_process_hardening`](https://github.com/firefam/firefam-cli/blob/main/codex-rs/process-hardening/README.md) so `firefam-responses-api-proxy` is run with standard process-hardening techniques.
