...
use firefam_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "FirefamSandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "Firefam sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(firefam_home);
    ...
    let secrets_dir = sandbox_secrets_dir(firefam_home);
