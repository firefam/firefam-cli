//! Write-path implementation for Firefam memories.
//!
...
mod guard_limits {
    pub(super) const FIREFAM_LIMIT_ID: &str = "firefam";
}
...
mod stage_one {
    ...
    pub(super) const REASONING_EFFORT: firefam_protocol::firefamai_models::ReasoningEffort =
        firefam_protocol::firefamai_models::ReasoningEffort::Low;
...
mod stage_two {
    ...
    pub(super) const REASONING_EFFORT: firefam_protocol::firefamai_models::ReasoningEffort =
        firefam_protocol::firefamai_models::ReasoningEffort::Medium;
    pub(super) const JOB_LEASE_SECONDS: i64 = 3_600;
    pub(super) const JOB_RETRY_DELAY_SECONDS: i64 = 3_600;
