...
use firefam_config::HookStateToml;
...
fn config_toml_source_path(layer: &ConfigLayerEntry) -> AbsolutePathBuf {
    match &layer.name {
        ...
        ConfigLayerSource::Project { dot_firefam_folder } => layer
            .hooks_config_folder()
            .unwrap_or_else(|| dot_firefam_folder.clone())
...
fn append_matcher_groups(
    ...
    display_order: &mut i64,
    source: &HookHandlerSource<'_>,
    event_name: firefam_protocol::protocol::HookEventName,
