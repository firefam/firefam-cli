...
async def _handle_connection(
    ...
    *,
    ...
    # Request 1: provoke a function call (mirrors `firefam-rs/core/tests/suite/agent_websocket.rs`).
...
start firefam with `firefam --profile localapi_ws`
""")
    sys.stdout.flush()
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Mock a minimal Responses API WebSocket endpoint for the `test_firefam` flow.\n"
