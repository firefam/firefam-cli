//! Rollout persistence and discovery for Firefam session files.
...
pub(crate) mod default_client {
    pub use firefam_login::default_client::*;
}

pub(crate) use firefam_protocol::protocol;
...
pub use firefam_protocol::protocol::SessionMeta;
pub use list::Cursor;
