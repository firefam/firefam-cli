...
`firefam-thread-store` is the storage boundary for Firefam threads. It defines the
...
- `LocalThreadStore` persists history through `firefam-rollout` JSONL files and
