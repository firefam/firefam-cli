...
pub(crate) struct ConfiguredHandler {
    pub event_name: firefam_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            firefam_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            firefam_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            firefam_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            firefam_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            firefam_protocol::protocol::HookEventName::PostCompact => "post-compact",
            firefam_protocol::protocol::HookEventName::SessionStart => "session-start",
            firefam_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            firefam_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            firefam_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<firefam_protocol::items::HookPromptFragment>,
    ) -> Vec<firefam_protocol::items::HookPromptFragment> {
        self.output_spiller
