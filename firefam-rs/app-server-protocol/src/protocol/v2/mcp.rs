...
use firefam_protocol::items::McpToolCallError as CoreMcpToolCallError;
use firefam_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use firefam_protocol::mcp::Resource as McpResource;
pub use firefam_protocol::mcp::ResourceContent as McpResourceContent;
use firefam_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use firefam_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from firefam_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> firefam_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => firefam_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => firefam_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => firefam_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Firefam turn when this elicitation was observed, if app-server could correlate one.
    ///
