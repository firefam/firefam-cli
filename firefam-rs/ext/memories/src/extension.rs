...
use firefam_memories_read::build_memory_tool_developer_instructions;
...
pub(crate) struct MemoriesExtensionConfig {
    ...
    pub(crate) firefam_home: AbsolutePathBuf,
}
...
impl ContextContributor for MemoriesExtension {
    fn contribute<'a>(
        ...
        Box::pin(async move {
            ...
            build_memory_tool_developer_instructions(&config.firefam_home)
                .await
...
impl ToolContributor for MemoriesExtension {
    fn tools(
        ...
        tools::memory_tools(LocalMemoriesBackend::from_firefam_home(
            &config.firefam_home,
        ))
    }
}
