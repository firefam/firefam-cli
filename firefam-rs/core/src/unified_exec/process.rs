...
use firefam_exec_server::ReadResponse as ExecReadResponse;
use firefam_exec_server::StartedExecProcess;
use firefam_exec_server::WriteStatus;
use firefam_protocol::exec_output::ExecToolCallOutput;
use firefam_protocol::exec_output::StreamOutput;
use firefam_protocol::protocol::TruncationPolicy;
use firefam_sandboxing::SandboxType;
use firefam_utils_output_truncation::formatted_truncate_text;
use firefam_utils_pty::ExecCommandSession;
use firefam_utils_pty::SpawnedPty;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = firefam_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
