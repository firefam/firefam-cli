"""Command-line interface for building Firefam package directories."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a canonical Firefam package directory and optional archive.",
...
def main() -> int:
    ...
    package_dir = (
        ...
        else Path(tempfile.mkdtemp(prefix="firefam-package-")).resolve()
    )
    ...
    inputs = PackageInputs(
        ...
        firefam_command_runner_bin=source_outputs.firefam_command_runner_bin,
        firefam_windows_sandbox_setup_bin=source_outputs.firefam_windows_sandbox_setup_bin,
    )
    ...
    if archive_output is not None:
        ...
        print(f"Built Firefam package archive at {archive_path}")

    print(f"Built Firefam package directory at {package_dir}")
    return 0
