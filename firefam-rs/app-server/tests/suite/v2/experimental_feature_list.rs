...
use firefam_app_server_protocol::ExperimentalFeature;
...
use firefam_app_server_protocol::ExperimentalFeatureStage;
...
-> Result<()> {
    let firefam_home = TempDir::new()?;
    let project_cwd = firefam_home.path().join("project");
