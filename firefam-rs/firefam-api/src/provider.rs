...
use firefam_client::RetryOn;
use firefam_client::RetryPolicy;
use http::Method;
...
///
/// This is converted into a `RetryPolicy` used by `firefam-client` to drive
...
mod tests {
    ...
    fn detects_azure_responses_base_urls() {
        let positive_cases = [
            ...
            "https://foo.cognitiveservices.azure.cn/firefamai",
        ...
        let negative_cases = [
            ...
            "https://example.com/firefamai",
            "https://myproxy.azurewebsites.net/firefamai",
        ];
