...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Firefam",
            ...
            SlashCommand::Permissions => "choose what Firefam is allowed to do",
            ...
            SlashCommand::Logout => "log out of Firefam",
