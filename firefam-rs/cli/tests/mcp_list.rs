...
async fn list_and_get_render_expected_output() -> Result<()> {
    ...
    let mut add = firefam_command(firefam_home.path())?;
    add.args([
        "mcp",
        "add",
        "docs",
    ...
    let mut servers = load_global_mcp_servers(firefam_home.path()).await?;
    ...
    let mut list_cmd = firefam_command(firefam_home.path())?;
    ...
    let mut list_json_cmd = firefam_command(firefam_home.path())?;
    ...
    let mut get_cmd = firefam_command(firefam_home.path())?;
    ...
    assert!(stdout.contains("remove: firefam mcp remove docs"));

    let mut get_json_cmd = firefam_command(firefam_home.path())?;
    get_json_cmd
