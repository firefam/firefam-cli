...
use firefam_app_server_protocol::GrantedPermissionProfile;
    ...
    fn converts_request_permissions_into_granted_permissions() {
        assert_eq!(
            granted_permission_profile_from_request(CoreRequestPermissionProfile::from(
                firefam_app_server_protocol::RequestPermissionProfile {
                    network: Some(firefam_app_server_protocol::AdditionalNetworkPermissions {
                        enabled: Some(true),
                    }),
                    file_system: Some(
                        firefam_app_server_protocol::AdditionalFileSystemPermissions {
            ...
            firefam_app_server_protocol::GrantedPermissionProfile {
                network: Some(firefam_app_server_protocol::AdditionalNetworkPermissions {
                    enabled: Some(true),
                }),
                file_system: Some(
                ...
                firefam_app_server_protocol::RequestPermissionProfile {
                    ...
                    file_system: Some(
                        firefam_app_server_protocol::AdditionalFileSystemPermissions {
                            ...
                            entries: Some(vec![
                                firefam_app_server_protocol::FileSystemSandboxEntry {
                                    path: firefam_app_server_protocol::FileSystemPath::Special {
                                        value:
                                            firefam_app_server_protocol::FileSystemSpecialPath::Root,
                                    },
                                    access:
                                        firefam_app_server_protocol::FileSystemAccessMode::Write,
                                }
                            ]),
                        }
                    ),
            ...
            firefam_app_server_protocol::GrantedPermissionProfile {
                ...
                file_system: Some(
                    firefam_app_server_protocol::AdditionalFileSystemPermissions {
                        ...
                        write: None,
                        glob_scan_max_depth: None,
                        entries: Some(vec![firefam_app_server_protocol::FileSystemSandboxEntry {
                            path: firefam_app_server_protocol::FileSystemPath::Special {
                                value: firefam_app_server_protocol::FileSystemSpecialPath::Root,
                            },
                            access: firefam_app_server_protocol::FileSystemAccessMode::Write,
                        },]),
                    }
