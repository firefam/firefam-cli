...
use firefam_protocol::dynamic_tools::DynamicToolCallRequest;
...
use firefam_tools::dynamic_tool_to_responses_api_tool;
    ...
    fn search_info(&self) -> Option<ToolSearchInfo> {
        ToolSearchInfo::from_spec(
            ...
            Some(ToolSearchSourceInfo {
                ...
                description: Some("Tools provided by the current Firefam thread.".to_string()),
            }),
        )
    }
}
