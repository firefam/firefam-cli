//! The main Firefam TUI chat surface.
//!
...
use firefam_app_server_protocol::CommandExecutionSource as ExecCommandSource;
use firefam_app_server_protocol::ConfigLayerSource;
use firefam_app_server_protocol::CreditsSnapshot;
use firefam_app_server_protocol::ErrorNotification;
use firefam_app_server_protocol::FileChangeRequestApprovalParams;
use firefam_app_server_protocol::FirefamErrorInfo as AppServerFirefamErrorInfo;
...
use firefam_app_server_protocol::ModelVerification as AppServerModelVerification;
use firefam_app_server_protocol::RateLimitReachedType;
...
use firefam_app_server_protocol::SkillMetadata as ProtocolSkillMetadata;
use firefam_app_server_protocol::SkillsListResponse;
use firefam_app_server_protocol::ThreadGoal as AppThreadGoal;
use firefam_app_server_protocol::ThreadGoalStatus as AppThreadGoalStatus;
...
use firefam_chatgpt::connectors as chatgpt_connectors;
...
use firefam_core_skills::model::SkillMetadata;
use firefam_features::FEATURES;
use firefam_features::Feature;
#[cfg(test)]
use firefam_git_utils::CommitLogEntry;
use firefam_git_utils::current_branch_name;
use firefam_git_utils::get_git_repo_root;
use firefam_git_utils::local_git_branches;
use firefam_git_utils::recent_commits;
use firefam_otel::RuntimeMetricsSummary;
use firefam_otel::SessionTelemetry;
use firefam_plugin::PluginCapabilitySummary;
use firefam_protocol::ThreadId;
use firefam_protocol::account::PlanType;
use firefam_protocol::approvals::GuardianAssessmentAction;
use firefam_protocol::approvals::GuardianAssessmentDecisionSource;
use firefam_protocol::approvals::GuardianAssessmentEvent;
use firefam_protocol::approvals::GuardianAssessmentStatus;
...
use firefam_protocol::items::AgentMessageContent;
use firefam_protocol::items::AgentMessageItem;
use firefam_protocol::models::MessagePhase;
use firefam_protocol::plan_tool::PlanItemArg as UpdatePlanItemArg;
use firefam_protocol::plan_tool::StepStatus as UpdatePlanItemStatus;
...
const MEMORIES_DOC_URL: &str = "https://support.firefam.ai/memories";
...
use firefam_file_search::FileMatch;
...
use firefam_utils_approval_presets::ApprovalPreset;
use firefam_utils_approval_presets::builtin_approval_presets;
use strum::IntoEnumIterator;
use unicode_segmentation::UnicodeSegmentation;

const USER_SHELL_COMMAND_HELP_TITLE: &str = "Prefix a command with ! to run it locally";
const USER_SHELL_COMMAND_HELP_HINT: &str = "Example: !ls";
const DEFAULT_FIREFAMAI_BASE_URL: &str = "https://api.openai.com/v1";
...
pub(crate) struct ChatWidgetInit {
    ...
    pub(crate) feedback: firefam_feedback::FirefamFeedback,
...
/// and by sending requests back to firefam-core.
///
...
pub(crate) struct ChatWidget {
    ...
    firefam_op_target: FirefamOpTarget,
    ...
    firefam_rate_limit_reached_type: Option<RateLimitReachedType>,
...
fn request_permissions_from_params(
    params: firefam_app_server_protocol::PermissionsRequestApprovalParams,
...
impl ChatWidget {
    ...
    /// Forward a command directly to firefam.
        ...
        T: Into<AppCommand>,
    {
        ...
        match &self.firefam_op_target {
            FirefamOpTarget::Direct(firefam_op_tx) => {
                crate::session_log::log_outbound_op(&op);
                if let Err(e) = firefam_op_tx.send(op) {
                    tracing::error!("failed to submit op: {e}");
                    return false;
                }
            }
            FirefamOpTarget::AppEvent => {
                self.app_event_tx.send(AppEvent::FirefamOp(op));
            }
        }
        true
    }
