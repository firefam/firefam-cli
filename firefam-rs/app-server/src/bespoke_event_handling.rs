...
use firefam_app_server_protocol::AccountRateLimitsUpdatedNotification;
use firefam_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use firefam_app_server_protocol::CommandAction as V2ParsedCommand;
use firefam_app_server_protocol::CommandExecutionApprovalDecision;
use firefam_app_server_protocol::CommandExecutionRequestApprovalParams;
use firefam_app_server_protocol::CommandExecutionRequestApprovalResponse;
use firefam_app_server_protocol::CommandExecutionSource;
use firefam_app_server_protocol::CommandExecutionStatus;
use firefam_app_server_protocol::DeprecationNoticeNotification;
use firefam_app_server_protocol::DynamicToolCallParams;
use firefam_app_server_protocol::DynamicToolCallStatus;
use firefam_app_server_protocol::ErrorNotification;
use firefam_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use firefam_app_server_protocol::FileChangeApprovalDecision;
use firefam_app_server_protocol::FileChangeRequestApprovalParams;
use firefam_app_server_protocol::FileChangeRequestApprovalResponse;
use firefam_app_server_protocol::FirefamErrorInfo as V2FirefamErrorInfo;
use firefam_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use firefam_app_server_protocol::GuardianWarningNotification;
use firefam_app_server_protocol::HookCompletedNotification;
use firefam_app_server_protocol::HookStartedNotification;
use firefam_app_server_protocol::ItemCompletedNotification;
use firefam_app_server_protocol::ItemStartedNotification;
use firefam_app_server_protocol::McpServerElicitationAction;
use firefam_app_server_protocol::McpServerElicitationRequestParams;
use firefam_app_server_protocol::McpServerElicitationRequestResponse;
use firefam_app_server_protocol::McpServerStartupState;
use firefam_app_server_protocol::McpServerStatusUpdatedNotification;
use firefam_app_server_protocol::ModelReroutedNotification;
use firefam_app_server_protocol::ModelVerificationNotification;
use firefam_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use firefam_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use firefam_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use firefam_app_server_protocol::PermissionsRequestApprovalParams;
use firefam_app_server_protocol::PermissionsRequestApprovalResponse;
use firefam_app_server_protocol::RawResponseItemCompletedNotification;
use firefam_app_server_protocol::RequestId;
use firefam_app_server_protocol::ServerNotification;
use firefam_app_server_protocol::ServerRequestPayload;
use firefam_app_server_protocol::ThreadGoalUpdatedNotification;
use firefam_app_server_protocol::ThreadItem;
use firefam_app_server_protocol::ThreadRealtimeClosedNotification;
use firefam_app_server_protocol::ThreadRealtimeErrorNotification;
use firefam_app_server_protocol::ThreadRealtimeItemAddedNotification;
use firefam_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use firefam_app_server_protocol::ThreadRealtimeSdpNotification;
use firefam_app_server_protocol::ThreadRealtimeStartedNotification;
use firefam_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use firefam_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use firefam_app_server_protocol::ThreadRollbackResponse;
use firefam_app_server_protocol::ThreadStatus;
use firefam_app_server_protocol::ThreadTokenUsage;
use firefam_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use firefam_app_server_protocol::ToolRequestUserInputOption;
use firefam_app_server_protocol::ToolRequestUserInputParams;
use firefam_app_server_protocol::ToolRequestUserInputQuestion;
use firefam_app_server_protocol::ToolRequestUserInputResponse;
use firefam_app_server_protocol::Turn;
use firefam_app_server_protocol::TurnCompletedNotification;
use firefam_app_server_protocol::TurnDiffUpdatedNotification;
...
use firefam_app_server_protocol::TurnPlanStep;
use firefam_app_server_protocol::TurnPlanUpdatedNotification;
use firefam_app_server_protocol::TurnStartedNotification;
use firefam_app_server_protocol::TurnStatus;
use firefam_app_server_protocol::WarningNotification;
use firefam_app_server_protocol::build_item_from_guardian_event;
use firefam_app_server_protocol::guardian_auto_approval_review_notification;
use firefam_app_server_protocol::item_event_to_server_notification;
use firefam_core::FirefamThread;
use firefam_core::ThreadManager;
use firefam_core::review_format::format_review_findings_block;
use firefam_core::review_prompts;
use firefam_protocol::ThreadId;
use firefam_protocol::items::parse_hook_prompt_message;
use firefam_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use firefam_protocol::plan_tool::UpdatePlanArgs;
use firefam_protocol::protocol::Event;
use firefam_protocol::protocol::EventMsg;
use firefam_protocol::protocol::ExecApprovalRequestEvent;
use firefam_protocol::protocol::FirefamErrorInfo as CoreFirefamErrorInfo;
use firefam_protocol::protocol::Op;
use firefam_protocol::protocol::RealtimeEvent;
use firefam_protocol::protocol::ReviewDecision;
use firefam_protocol::protocol::ReviewOutputEvent;
...
use firefam_protocol::protocol::TurnDiffEvent;
use firefam_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use firefam_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use firefam_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use firefam_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use firefam_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use firefam_sandboxing::policy_transforms::intersect_permission_profiles;
use firefam_shell_command::parse_command::shlex_join;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<FirefamThread>,
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error) = match update.status {
                firefam_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None)
                }
                firefam_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None)
                }
                firefam_protocol::protocol::McpStartupStatus::Failed { error } => {
                    (McpServerStartupState::Failed, Some(error))
                }
                firefam_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == firefam_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                firefam_protocol::protocol::GuardianAssessmentStatus::Denied
                | firefam_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                firefam_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                firefam_protocol::protocol::GuardianAssessmentStatus::InProgress
                | firefam_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: firefam_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let firefam_error_info = ev.firefam_error_info.clone();
            ...
            if matches!(
                firefam_error_info,
                Some(CoreFirefamErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                firefam_error_info: ev.firefam_error_info.map(V2FirefamErrorInfo::from),
        ...
        EventMsg::ExecCommandBegin(exec_command_begin_event) => {
            if matches!(
                ...
                firefam_protocol::protocol::ExecCommandSource::UnifiedExecInteraction
            ) {
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: firefam_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
pub(crate) async fn maybe_emit_hook_prompt_item_completed(
    ...
    let firefam_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(firefam_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: firefam_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: firefam_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<FirefamThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: firefam_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            firefam_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use firefam_app_server_protocol::AutoReviewDecisionSource;
    use firefam_app_server_protocol::GuardianApprovalReviewStatus;
    use firefam_app_server_protocol::JSONRPCErrorError;
    use firefam_app_server_protocol::TurnPlanStepStatus;
    use firefam_login::FirefamAuth;
    use firefam_protocol::items::HookPromptFragment;
    use firefam_protocol::items::build_hook_prompt_message;
    use firefam_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use firefam_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    ...
    use firefam_protocol::plan_tool::PlanItemArg;
    use firefam_protocol::plan_tool::StepStatus;
    use firefam_protocol::protocol::AgentMessageEvent;
    use firefam_protocol::protocol::AskForApproval;
    use firefam_protocol::protocol::CreditsSnapshot;
    use firefam_protocol::protocol::EventMsg;
    use firefam_protocol::protocol::GuardianAssessmentEvent;
    use firefam_protocol::protocol::GuardianAssessmentStatus;
    ...
    use firefam_utils_absolute_path::AbsolutePathBuf;
    use firefam_utils_absolute_path::test_support::PathBufExt;
    use firefam_utils_absolute_path::test_support::test_path_buf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            reason: firefam_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(firefam_protocol::protocol::GuardianRiskLevel::Low),
                Some(firefam_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(firefam_protocol::protocol::GuardianRiskLevel::High),
                Some(firefam_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(firefam_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = firefam_protocol::protocol::GuardianAssessmentAction::Command {
            source: firefam_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: firefam_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: firefam_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(firefam_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(
                    firefam_protocol::protocol::GuardianUserAuthorization::Low,
                ),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    firefam_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(firefam_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(firefam_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = firefam_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: firefam_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: firefam_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            firefam_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&firefam_home).await;
        let thread_manager = Arc::new(
            firefam_core::test_support::thread_manager_with_models_provider_and_home(
                FirefamAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.firefam_home.to_path_buf(),
                Arc::new(firefam_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let firefam_core::NewThread {
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                firefam_error_info: Some(V2FirefamErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(firefam_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(firefam_protocol::protocol::UserMessageEvent {
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(firefam_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    started_at: Some(42),
                    model_context_window: None,
                    collaboration_mode_kind: Default::default(),
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                firefam_error_info: Some(V2FirefamErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            OutgoingMessage::AppServerNotification(
                ...
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("firefam"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                firefam_error_info: Some(V2FirefamErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            firefam_app_server_protocol::HookPromptFragment {
