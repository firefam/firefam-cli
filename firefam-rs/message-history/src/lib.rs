...
//!
//! The history is stored at `~/.agents/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.agents`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.agents/history.jsonl` and ensure the parent directory exists.
