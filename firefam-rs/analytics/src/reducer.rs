...
use crate::events::FirefamCollabAgentToolCallEventParams;
use crate::events::FirefamCollabAgentToolCallEventRequest;
...
use crate::events::FirefamDynamicToolCallEventParams;
use crate::events::FirefamDynamicToolCallEventRequest;
use crate::events::FirefamFileChangeEventParams;
use crate::events::FirefamFileChangeEventRequest;
use crate::events::FirefamHookRunEventRequest;
use crate::events::FirefamImageGenerationEventParams;
use crate::events::FirefamImageGenerationEventRequest;
use crate::events::FirefamMcpToolCallEventParams;
use crate::events::FirefamMcpToolCallEventRequest;
...
use crate::events::FirefamTurnEventParams;
use crate::events::FirefamTurnEventRequest;
use crate::events::FirefamTurnSteerEventParams;
use crate::events::FirefamTurnSteerEventRequest;
use crate::events::FirefamWebSearchEventParams;
use crate::events::FirefamWebSearchEventRequest;
...
use crate::events::firefam_compaction_event_params;
...
use firefam_app_server_protocol::ClientResponse;
use firefam_app_server_protocol::CollabAgentStatus;
...
use firefam_app_server_protocol::DynamicToolCallOutputContentItem;
...
use firefam_app_server_protocol::NetworkPolicyRuleAction;
use firefam_app_server_protocol::PatchApplyStatus;
use firefam_app_server_protocol::PatchChangeKind;
...
use firefam_app_server_protocol::WebSearchAction;
use firefam_git_utils::collect_git_info;
...
impl<'a> AnalyticsDropSite<'a> {
    ...
    fn compaction(input: &'a FirefamCompactionEvent) -> Self {
        Self {
    ...
    fn tool_item(
        notification: &'a firefam_app_server_protocol::ItemCompletedNotification,
        item_id: &'a str,
    ) -> Self {
        Self {
...
struct CompletedTurnState {
    ...
    turn_error: Option<FirefamErrorInfo>,
    completed_at: u64,
...
impl AnalyticsReducer {
    ...
    fn ingest_guardian_review(
        ...
        out.push(TrackEventRequest::GuardianReview(Box::new(
            GuardianReviewEventRequest {
                event_type: "firefam_guardian_review",
    ...
    fn ingest_app_mentioned(&mut self, input: AppMentionedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.extend(mentions.into_iter().map(|mention| {
            let event_params = firefam_app_metadata(&tracking, mention);
            TrackEventRequest::AppMentioned(FirefamAppMentionedEventRequest {
    ...
    fn ingest_app_used(&mut self, input: AppUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        let event_params = firefam_app_metadata(&tracking, app);
        out.push(TrackEventRequest::AppUsed(FirefamAppUsedEventRequest {
    ...
    fn ingest_hook_run(&mut self, input: HookRunInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::HookRun(FirefamHookRunEventRequest {
            event_type: "firefam_hook_run",
            event_params: firefam_hook_run_metadata(&tracking, hook),
        }));
    }
    ...
    fn ingest_plugin_used(&mut self, input: PluginUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::PluginUsed(
            FirefamPluginUsedEventRequest {
                event_type: "firefam_plugin_used",
                event_params: firefam_plugin_used_metadata(&tracking, plugin),
            },
        ));
    }
    ...
    fn ingest_plugin_state_changed(
        ...
        let event = FirefamPluginEventRequest {
            ...
            ServerNotification::TurnCompleted(notification) => {
                ...
                turn_state.completed = Some(CompletedTurnState {
                    ...
                    turn_error: notification
                        .turn
                        .error
                        .and_then(|error| error.firefam_error_info),
    ...
    fn ingest_compaction(
        ...
        out.push(TrackEventRequest::Compaction(Box::new(
            FirefamCompactionEventRequest {
                event_type: "firefam_compaction_event",
                event_params: firefam_compaction_event_params(
                    input,
    ...
    fn ingest_guardian_review_completed(
        &mut self,
        notification: firefam_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification,
        out: &mut Vec<TrackEventRequest>,
    ) {
    ...
    fn emit_turn_steer_event(
        ...
        out.push(TrackEventRequest::TurnSteer(FirefamTurnSteerEventRequest {
            event_type: "firefam_turn_steer_event",
            event_params: FirefamTurnSteerEventParams {
    ...
    fn emit_review_event(
        ...
        out.push(TrackEventRequest::ReviewEvent(FirefamReviewEventRequest {
    ...
    async fn maybe_emit_turn_event(&mut self, turn_id: &str, out: &mut Vec<TrackEventRequest>) {
        ...
        let turn_event = TrackEventRequest::TurnEvent(Box::new(FirefamTurnEventRequest {
            event_type: "firefam_turn_event",
            event_params: firefam_turn_event_params(
                connection_state.app_server_client.clone(),
                connection_state.runtime.clone(),
                turn_id.to_string(),
                turn_state,
    ...
    match item {
        ThreadItem::CommandExecution {
            ...
            Some(TrackEventRequest::CommandExecution(
                FirefamCommandExecutionEventRequest {
        ...
        ThreadItem::FileChange {
            ...
            Some(TrackEventRequest::FileChange(
                FirefamFileChangeEventRequest {
                    event_type: "firefam_file_change_event",
                    event_params: FirefamFileChangeEventParams {
                        base,
        ...
        ThreadItem::McpToolCall {
            ...
            Some(TrackEventRequest::McpToolCall(
                FirefamMcpToolCallEventRequest {
                    event_type: "firefam_mcp_tool_call_event",
                    event_params: FirefamMcpToolCallEventParams {
                        base,
        ...
        ThreadItem::DynamicToolCall {
            ...
            Some(TrackEventRequest::DynamicToolCall(
                FirefamDynamicToolCallEventRequest {
                    event_type: "firefam_dynamic_tool_call_event",
                    event_params: FirefamDynamicToolCallEventParams {
                        base,
        ...
        ThreadItem::CollabAgentToolCall {
            ...
            Some(TrackEventRequest::CollabAgentToolCall(
                FirefamCollabAgentToolCallEventRequest {
                    event_type: "firefam_collab_agent_tool_call_event",
                    event_params: FirefamCollabAgentToolCallEventParams {
                        base,
        ...
        ThreadItem::WebSearch { id, query, action } => {
            ...
            Some(TrackEventRequest::WebSearch(FirefamWebSearchEventRequest {
                event_type: "firefam_web_search_event",
                event_params: FirefamWebSearchEventParams {
                    base,
        ...
        ThreadItem::ImageGeneration {
            ...
            Some(TrackEventRequest::ImageGeneration(
                FirefamImageGenerationEventRequest {
                    event_type: "firefam_image_generation_event",
                    event_params: FirefamImageGenerationEventParams {
                        base,
...
fn file_change_counts(
    changes: &[firefam_app_server_protocol::FileUpdateChange],
) -> FileChangeCounts {
...
fn firefam_turn_event_params(
    app_server_client: FirefamAppServerClientMetadata,
    runtime: FirefamRuntimeMetadata,
    turn_id: String,
    turn_state: &TurnState,
    thread_metadata: &ThreadMetadataState,
) -> FirefamTurnEventParams {
...
fn analytics_turn_status(status: firefam_app_server_protocol::TurnStatus) -> Option<TurnStatus> {
    match status {
        firefam_app_server_protocol::TurnStatus::Completed => Some(TurnStatus::Completed),
        firefam_app_server_protocol::TurnStatus::Failed => Some(TurnStatus::Failed),
        firefam_app_server_protocol::TurnStatus::Interrupted => Some(TurnStatus::Interrupted),
        firefam_app_server_protocol::TurnStatus::InProgress => None,
    }
}
