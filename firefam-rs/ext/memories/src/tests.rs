...
use firefam_extension_api::ToolCall;
use firefam_extension_api::ToolContributor;
use firefam_extension_api::ToolExecutor;
use firefam_extension_api::ToolName;
use firefam_extension_api::ToolPayload;
...
fn tools_are_not_contributed_when_disabled() {
    ...
    thread_store.insert(MemoriesExtensionConfig {
        enabled: false,
        firefam_home: test_path_buf("/tmp/firefam-home").abs(),
    });
