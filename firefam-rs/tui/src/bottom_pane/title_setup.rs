...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "Firefam app name",
            ...
            TerminalTitleItem::FirefamVersion => "Firefam application version",
    ...
    pub(crate) fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::FirefamVersion => Some(StatusSurfacePreviewItem::FirefamVersion),
    ...
    fn parse_terminal_title_items_accepts_kebab_case_variants() {
        ...
        assert_eq!(
            ...
            Some(vec![
                ...
                TerminalTitleItem::ModelWithReasoning,
                TerminalTitleItem::WeeklyLimit,
                TerminalTitleItem::FirefamVersion,
