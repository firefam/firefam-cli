...
//! "leave the old title alone" or "clear the title Firefam last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Firefam manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Firefam started managing the title.
