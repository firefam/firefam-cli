...
impl ResolvedTurnEnvironments {
    ...
    pub(crate) fn primary_environment(&self) -> Option<Arc<firefam_exec_server::Environment>> {
        self.primary()
...
pub(crate) fn resolve_environment_selections(
    ...
    for selected_environment in environments {
        ...
        let environment = environment_manager
            ...
            .ok_or_else(|| {
                FirefamErr::InvalidRequest(format!(
...
"#,
        ...
        let cwd = AbsolutePathBuf::current_dir().expect("cwd");
        let manager =
            EnvironmentManager::from_firefam_home(temp_dir.path(), Some(test_runtime_paths()))
                .await
