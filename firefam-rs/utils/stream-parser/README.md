# firefam-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Firefam did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Firefam on it. Feel free to update the documentation as you
modify the code
...
```rust
use firefam_utils_stream_parser::CitationStreamParser;
use firefam_utils_stream_parser::StreamTextParser;
...
```rust
use firefam_utils_stream_parser::CitationStreamParser;
use firefam_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), firefam_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use firefam_utils_stream_parser::InlineHiddenTagParser;
use firefam_utils_stream_parser::InlineTagSpec;
use firefam_utils_stream_parser::StreamTextParser;
