...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: firefam_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, firefam_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                firefam_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                firefam_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                firefam_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                firefam_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                firefam_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                firefam_app_server_protocol::GuardianRiskLevel::Low => {
                    firefam_protocol::approvals::GuardianRiskLevel::Low
                }
                firefam_app_server_protocol::GuardianRiskLevel::Medium => {
                    firefam_protocol::approvals::GuardianRiskLevel::Medium
                }
                firefam_app_server_protocol::GuardianRiskLevel::High => {
                    firefam_protocol::approvals::GuardianRiskLevel::High
                }
                firefam_app_server_protocol::GuardianRiskLevel::Critical => {
                    firefam_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    firefam_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        firefam_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    firefam_app_server_protocol::GuardianUserAuthorization::Low => {
                        firefam_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    firefam_app_server_protocol::GuardianUserAuthorization::Medium => {
                        firefam_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    firefam_app_server_protocol::GuardianUserAuthorization::High => {
                        firefam_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                firefam_app_server_protocol::AutoReviewDecisionSource::Agent => {
