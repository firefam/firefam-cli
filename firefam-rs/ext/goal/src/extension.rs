...
use firefam_extension_api::ConfigContributor;
use firefam_extension_api::ExtensionData;
use firefam_extension_api::ExtensionEventSink;
use firefam_extension_api::ExtensionRegistryBuilder;
use firefam_extension_api::NoopExtensionEventSink;
use firefam_extension_api::ThreadLifecycleContributor;
use firefam_extension_api::ThreadStartInput;
use firefam_extension_api::TokenUsageContributor;
use firefam_extension_api::ToolCallOutcome;
use firefam_extension_api::ToolContributor;
use firefam_extension_api::ToolFinishInput;
use firefam_extension_api::ToolLifecycleContributor;
use firefam_extension_api::ToolLifecycleFuture;
use firefam_extension_api::TurnAbortInput;
use firefam_extension_api::TurnLifecycleContributor;
use firefam_extension_api::TurnStartInput;
use firefam_extension_api::TurnStopInput;
    ...
    C: Send + Sync + 'static,
{
    fn tools(
        ...
        _session_store: &ExtensionData,
        thread_store: &ExtensionData,
    ) -> Vec<Arc<dyn firefam_extension_api::ToolExecutor<firefam_extension_api::ToolCall>>> {
        if !goal_enabled(thread_store) {
            return Vec::new();
        }
