...
use firefam_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use firefam_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use firefam_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use firefam_protocol::firefamai_models::ReasoningEffort;
use firefam_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use firefam_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use firefam_protocol::protocol::AgentStatus as CoreAgentStatus;
use firefam_protocol::protocol::ExecCommandSource as CoreExecCommandSource;
use firefam_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
use firefam_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use firefam_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use firefam_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use firefam_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
impl From<firefam_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: firefam_protocol::models::WebSearchAction) -> Self {
        match value {
            firefam_protocol::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            firefam_protocol::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            firefam_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            firefam_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<firefam_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: firefam_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<DynamicToolCallOutputContentItem>
    for firefam_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
