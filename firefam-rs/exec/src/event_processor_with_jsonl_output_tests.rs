...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        firefam_app_server_protocol::TurnCompletedNotification {
            ...
            turn: firefam_app_server_protocol::Turn {
                ...
                error: Some(firefam_app_server_protocol::TurnError {
    ...
    assert_eq!(status, FirefamStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        firefam_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "Firefam CLI documentation"}]}),
                mcp_app_resource_uri: None,
                result: Some(Box::new(firefam_app_server_protocol::McpToolCallResult {
