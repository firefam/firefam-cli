...
impl ToolCallRuntime {
    ...
    pub(crate) fn handle_tool_call(
    ...
    ) -> impl std::future::Future<Output = Result<ResponseInputItem, FirefamErr>> {
        ...
        async move {
            match future.await {
                ...
                Err(FunctionCallError::Fatal(message)) => Err(FirefamErr::Fatal(message)),
        ...
        match call.payload {
            ...
            ToolPayload::Custom { .. } => ResponseInputItem::CustomToolCallOutput {
                ...
                output: firefam_protocol::models::FunctionCallOutputPayload {
                    body: firefam_protocol::models::FunctionCallOutputBody::Text(message),
                    success: Some(false),
                },
            },
...
mod tests {
    ...
    impl firefam_extension_api::ToolLifecycleContributor for BlockingFinishContributor {
        fn on_tool_finish<'a>(
            &'a self,
    ...
    -> anyhow::Result<()> {
        ...
        let tool_name = firefam_tools::ToolName::plain("test_tool");
