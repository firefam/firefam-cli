...
mod tests {
    ...
    async fn open_pull_request_falls_back_to_parent_repo_commit_lookup() {
        let runner = FakeRunner::new(vec![
            ...
            response(
                ...
                /*exit_code*/ 0,
                r#"{"nameWithOwner":"fcoury/firefam","parent":{"nameWithOwner":"firefamai/firefam"}}"#,
            ),
            response(
                &[
                    "gh",
                    ...
                    "-H",
                    "Accept: application/vnd.github+json",
                    "repos/firefamai/firefam/commits/head-sha/pulls",
                ],
                /*exit_code*/ 0,
    ...
    fn status_line_pr_fallback_searches_parent_repo_first() {
        assert_eq!(
            ...
            Some(vec![
                "firefamai/firefam".to_string(),
                "fcoury/firefam".to_string()
            ])
        );
    }
