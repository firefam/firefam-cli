...
#   filename:  firefam_app_server_protocol.v2.schemas.json
...
class FirefamAppServerProtocolV2(BaseModel):
    pass
...
class FirefamErrorInfoValue(Enum):
...
class HttpConnectionFailedFirefamErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedFirefamErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedFirefamErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsFirefamErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_firefam_folder: Annotated[AbsolutePathBuf, Field(alias="dotFirefamFolder")]
...
class ExternalAgentConfigDetectParams(BaseModel):
    ...
    include_home: Annotated[
        ...
        Field(
            alias="includeHome",
            description="If true, include detection under the user's home (~/.claude, ~/.firefam, etc.).",
        ),
    ] = None
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    firefam_streamlined_login: Annotated[bool | None, Field(alias="firefamStreamlinedLogin")] = None
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `firefam_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerableFirefamErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class FirefamErrorInfo(
    RootModel[
        FirefamErrorInfoValue
        | HttpConnectionFailedFirefamErrorInfo
        | ResponseStreamConnectionFailedFirefamErrorInfo
        | ResponseStreamDisconnectedFirefamErrorInfo
        | ResponseTooManyFailedAttemptsFirefamErrorInfo
        | ActiveTurnNotSteerableFirefamErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class GetAccountResponse(BaseModel):
    ...
    requires_firefamai_auth: Annotated[bool, Field(alias="requiresOpenaiAuth")]
...
class TurnError(BaseModel):
    ...
    firefam_error_info: Annotated[FirefamErrorInfo | None, Field(alias="firefamErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `firefam`).",
        ),
    ] = None
...
class Thread(BaseModel):
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, firefam exec, firefam app-server, etc.)."
        ),
    ]
